...
public class SlideDateTimePicker
{
    ...
    {
        mIsClientSpecified24HourTime = false;
    }
    ...
    public static class Builder
    {
        ...
        public Builder setisClientSpecified24HourTime(boolean isClientSpecified24HourTime)
        {
        	this.isClientSpecified24HourTime = isClientSpecified24HourTime;
        	return this;
        }
        ...
        public SlideDateTimePicker build()
        {
            ...
            picker.setSelectItem(selectItem);
            return picker;
        }
    }
}
