...
public class ScheduleDetailPageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private WordWrapView wwTags;            //保存标签的容器
    ArrayList<String> tags = new ArrayList<>();   //已选的标签
    List<View> tagViewList = new ArrayList<>();    //单个标签view的list
    View normalBtn;              //修改和删除按钮的容器layout
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContext(findViewById(R.id.toolbar), getString(R.string.schedule_detail), true);

        initView();
        initData();
        normal();  //首先设置为正常状态，该状态下不可修改
    }
    ...
    private void modify() {
        findViewById(R.id.tv_date).setClickable(true);
        findViewById(R.id.tv_minute).setClickable(true);
        findViewById(R.id.add_tag).setVisibility(View.VISIBLE);
        findViewById(R.id.content).setEnabled(true);
        findViewById(R.id.repeat).setClickable(true);
    ...
    private void normal() {
        findViewById(R.id.tv_date).setClickable(false);
        findViewById(R.id.tv_minute).setClickable(false);
        findViewById(R.id.add_tag).setVisibility(View.GONE);
        findViewById(R.id.content).setEnabled(false);
        findViewById(R.id.repeat).setClickable(false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.repeat:
                ...
                break;
            case R.id.add_tag:
                intent.setClass(ScheduleDetailPageActivity.this, AddTagsActivity.class);
