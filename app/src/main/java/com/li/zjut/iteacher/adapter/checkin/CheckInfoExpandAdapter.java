 ...
 */
public class CheckInfoExpandAdapter implements ExpandableListAdapter {

    private List<ThreeType> mDatas;
    private Context context;

    public CheckInfoExpandAdapter(Context context, List<ThreeType> mDatas) {

        this.context = context;
        this.mDatas = mDatas;
    }

    public void setmDatas(List<ThreeType> mDatas) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        tv.setText(mDatas.get(groupPosition).getType());
        return tv;
    }

    @Override
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        String info = mDatas.get(groupPosition).getList().get(childPosition).getName();
        if (convertView == null) {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
