...
import com.li.zjut.iteacher.common.CommUtil;
...
public class MapOnePlaceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_one_place);
        super.setContext(findViewById(R.id.toolbar), getString(R.string.check_place), true);
    ...
    private void initData() {
        ...
        LatLng stuLatLng = getIntent().getParcelableExtra("student");
        LatLng teaLatLng = getIntent().getParcelableExtra("teacher");
        addCircle(teaLatLng);
        addMarker(stuLatLng, "王河");
    }
    ...
    private void addMarker(LatLng latLng, String name) {
        ...
        img.setImageDrawable(com.li.zjut.iteacher.common.Utils.getCircleBg(name.substring(0, 1), this));
