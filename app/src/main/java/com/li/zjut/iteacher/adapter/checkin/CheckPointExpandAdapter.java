 ...
 */
public class CheckPointExpandAdapter implements ExpandableListAdapter {

    private List<Curriculum> mDatas;
    private Context context;

    public CheckPointExpandAdapter(Context context, List<Curriculum> mDatas) {

        this.context = context;
        this.mDatas = mDatas;
    }

    public void setmDatas(List<Curriculum> mDatas) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        tv.setText(mDatas.get(groupPosition).getName());
        return tv;
    }
